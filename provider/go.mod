...
require (
	github.com/cloudy-sky-software/pulschema v0.0.0-20221112034527-0d3b497d5da2
	github.com/cloudy-sky-software/pulumi-provider-framework v0.0.0-20221112111434-890ef65dd0da
