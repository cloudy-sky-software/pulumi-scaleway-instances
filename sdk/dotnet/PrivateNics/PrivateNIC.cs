...
namespace Pulumi.ScalewayInstances.PrivateNics
{
    ...
    public partial class PrivateNIC : global::Pulumi.CustomResource
    {
        ...
        private PrivateNIC(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("scaleway-instances:private_nics:PrivateNIC", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivateNIC Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new PrivateNIC(name, id, options);
        }
    }
