...
namespace Pulumi.ScalewayInstances
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/cloudy-sky-software/pulumi-scaleway-instances";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ScalewayInstances.version.txt");
    ...
    internal sealed class ScalewayInstancesResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ScalewayInstancesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
