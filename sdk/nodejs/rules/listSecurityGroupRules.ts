...
export function listSecurityGroupRules(args: ListSecurityGroupRulesArgs, opts?: pulumi.InvokeOptions): Promise<outputs.rules.ScalewayInstanceV1ListSecurityGroupRulesResponse> {
