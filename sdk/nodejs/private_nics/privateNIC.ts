...
export class PrivateNIC extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateNIC {
        return new PrivateNIC(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway-instances:private_nics:PrivateNIC';
    ...
    public /*out*/ readonly privateNic!: pulumi.Output<outputs.private_nics.ScalewayInstanceV1PrivateNIC | undefined>;
    ...
    constructor(name: string, args: PrivateNICArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["privateNic"] = undefined /*out*/;
        } else {
            resourceInputs["privateNetworkId"] = undefined /*out*/;
            resourceInputs["privateNic"] = undefined /*out*/;
        }
