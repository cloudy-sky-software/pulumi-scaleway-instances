...
def list_volumes(zone: Optional[builtins.str] = None,
...
def list_volumes_output(zone: Optional[pulumi.Input[builtins.str]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ScalewayInstanceV1ListVolumesResponse]:
    """
    Use this data source to access information about an existing resource.
