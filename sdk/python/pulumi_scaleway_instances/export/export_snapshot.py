...
class ExportSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: S3 bucket name
        :param pulumi.Input[builtins.str] key: S3 object key
        :param pulumi.Input[builtins.str] snapshot_id: The snapshot ID
