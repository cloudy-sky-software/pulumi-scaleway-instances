...
if not MYPY:
    class ScalewayInstanceV1BootscriptArgsDict(TypedDict):
        ...
        The bootscript arch
        """
        bootcmdargs: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        dtb: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The bootscript ID
        """
        initrd: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ScalewayInstanceV1BootscriptArgs:
    def __init__(__self__, *,
                 ...
                 bootcmdargs: Optional[pulumi.Input[builtins.str]] = None,
                 default: Optional[pulumi.Input[builtins.bool]] = None,
                 dtb: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 initrd: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bootcmdargs: The bootscript arguments
        :param pulumi.Input[builtins.bool] default: Dispmay if the bootscript is the default bootscript if no other boot option is configured
        :param pulumi.Input[builtins.str] dtb: Provide information regarding a Device Tree Binary (dtb) for use with C1 servers
        :param pulumi.Input[builtins.str] id: The bootscript ID
        :param pulumi.Input[builtins.str] initrd: The initrd (initial ramdisk) configuration
        :param pulumi.Input[builtins.str] kernel: The server kernel version
        :param pulumi.Input[builtins.str] organization: The bootscript organization ID
        :param pulumi.Input[builtins.str] project: The bootscript project ID
        :param pulumi.Input[builtins.bool] public: Provide information if the bootscript is public
        :param pulumi.Input[builtins.str] title: The bootscript title
        :param pulumi.Input[builtins.str] zone: The zone in which is the bootscript
        """
        if arch is None:
            arch = 'x86_64'
        if arch is not None:
    ...
    @property
    @pulumi.getter
    def bootcmdargs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The bootscript arguments
        """
    ...
    @bootcmdargs.setter
    def bootcmdargs(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def dtb(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Provide information regarding a Device Tree Binary (dtb) for use with C1 servers
        """
    ...
    @dtb.setter
    def dtb(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def initrd(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The initrd (initial ramdisk) configuration
        """
    ...
    @initrd.setter
    def initrd(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScalewayInstanceV1VolumeSummaryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] size: (in bytes)
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
class ScalewayInstanceV1VolumeArgs:
    def __init__(__self__, *,
                 ...
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The volume name
        :param pulumi.Input[builtins.str] project: The volume project ID
        :param pulumi.Input[builtins.str] creation_date: The volume creation date (RFC 3339 format)
        :param pulumi.Input[builtins.str] export_uri: Show the volume NBD export URI
        :param pulumi.Input[builtins.str] modification_date: The volume modification date (RFC 3339 format)
        :param pulumi.Input[builtins.str] organization: The volume organization ID
        :param pulumi.Input['ScalewayInstanceV1VolumeServerPropertiesArgs'] server: The server attached to the volume
        :param pulumi.Input[builtins.float] size: The volume disk size (in bytes)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The volume tags
        :param pulumi.Input[builtins.str] zone: The zone in which is the volume
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "project", project)
