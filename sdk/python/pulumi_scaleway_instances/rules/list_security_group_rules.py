...
def list_security_group_rules(security_group_id: Optional[builtins.str] = None,
                              zone: Optional[builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableScalewayInstanceV1ListSecurityGroupRulesResponse:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str security_group_id: UUID of the security group
...
def list_security_group_rules_output(security_group_id: Optional[pulumi.Input[builtins.str]] = None,
