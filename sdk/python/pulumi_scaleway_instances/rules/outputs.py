...
class ScalewayInstanceV1SecurityGroupRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dest_port_from: Optional[builtins.float] = None,
                 dest_port_to: Optional[builtins.float] = None,
                 direction: Optional['ScalewayInstanceV1SecurityGroupRuleDirection'] = None,
                 editable: Optional[builtins.bool] = None,
                 id: Optional[builtins.str] = None,
                 ip_range: Optional[builtins.str] = None,
                 position: Optional[builtins.float] = None,
                 protocol: Optional['ScalewayInstanceV1SecurityGroupRuleProtocol'] = None,
                 zone: Optional[builtins.str] = None):
        """
        :param builtins.str ip_range: (IP network)
        """
        if action is None:
            action = 'accept'
    ...
    def dest_port_from(self) -> Optional[builtins.float]:
        return pulumi.get(self, "dest_port_from")

    @property
    @pulumi.getter(name="destPortTo")
    def dest_port_to(self) -> Optional[builtins.float]:
    ...
    @property
    @pulumi.getter
    def editable(self) -> Optional[builtins.bool]:
    ...
    @property
    @pulumi.getter
    def position(self) -> Optional[builtins.float]:
