...
class SecurityGroupRulesArgs:
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ScalewayInstanceV1SetSecurityGroupRulesRequestRuleArgs']]]]:
        """
...
class SecurityGroupRules(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SecurityGroupRules':
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence['outputs.ScalewayInstanceV1SetSecurityGroupRulesRequestRule']]]:
        """
        List of rules to update in the security group
        """
        return pulumi.get(self, "rules")
