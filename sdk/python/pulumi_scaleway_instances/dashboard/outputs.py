...
class ScalewayInstanceV1Dashboard(dict):
    def __init__(__self__, *,
                 ...
                 ips_count: Optional[builtins.float] = None,
                 ips_unused: Optional[builtins.float] = None,
                 placement_groups_count: Optional[builtins.float] = None,
                 private_nics_count: Optional[builtins.float] = None,
                 running_servers_count: Optional[builtins.float] = None,
                 security_groups_count: Optional[builtins.float] = None,
                 servers_by_types: Optional[Mapping[str, builtins.float]] = None,
                 servers_count: Optional[builtins.float] = None,
                 snapshots_count: Optional[builtins.float] = None,
                 volumes_bssd_count: Optional[builtins.float] = None,
                 volumes_bssd_total_size: Optional[builtins.float] = None,
                 volumes_count: Optional[builtins.float] = None,
                 volumes_lssd_count: Optional[builtins.float] = None,
                 volumes_lssd_total_size: Optional[builtins.float] = None):
