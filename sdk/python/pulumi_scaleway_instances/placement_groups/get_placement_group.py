...
def get_placement_group(id: Optional[builtins.str] = None,
                        zone: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableScalewayInstanceV1GetPlacementGroupResponse:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str id: UUID of the placement group you want to get
...
def get_placement_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
