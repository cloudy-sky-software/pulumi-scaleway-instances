...
class PlacementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The placement group project ID
        :param pulumi.Input[builtins.str] name: The placement group name
        :param pulumi.Input[builtins.str] organization: The placement group organization ID
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The placement group tags
...
class PlacementGroup(pulumi.CustomResource):
    ...
    def policy_respected(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
