...
class ScalewayInstanceV1Image(dict):
    ...
    def __init__(__self__, *,
                 ...
                 from_server: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 ...
                 zone: Optional[builtins.str] = None):
        """
        :param builtins.str creation_date: (RFC 3339 format)
        :param builtins.str modification_date: (RFC 3339 format)
        """
    ...
    def from_server(self) -> Optional[builtins.str]:
...
class ScalewayInstanceV1PlacementGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 policy_respected: Optional[builtins.bool] = None,
                 policy_type: Optional['ScalewayInstanceV1PlacementGroupPolicyType'] = None,
                 tags: Optional[Sequence[builtins.str]] = None,
                 zone: Optional[builtins.str] = None):
        """
        :param builtins.str name: The placement group name
        :param builtins.str project: The placement group project ID
        :param builtins.str organization: The placement group organization ID
        :param builtins.bool policy_respected: Returns true if the policy is respected, false otherwise
        :param Sequence[builtins.str] tags: The placement group tags
        :param builtins.str zone: The zone in which is the placement group
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "project", project)
        if id is not None:
    ...
    def policy_respected(self) -> Optional[builtins.bool]:
        """
...
class ScalewayInstanceV1PlacementGroupServer(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "policyRespected":
            suggest = "policy_respected"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ScalewayInstanceV1PlacementGroupServer. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ScalewayInstanceV1PlacementGroupServer.__key_warning(key)
        return super().__getitem__(key)
...
class ScalewayInstanceV1PrivateNIC(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The private NIC unique ID
        :param builtins.str mac_address: The private NIC MAC address
        :param builtins.str private_network_id: The private network where the private NIC is attached
        :param builtins.str server_id: The server the private NIC is attached to
...
class ScalewayInstanceV1Server(dict):
    ...
    def __init__(__self__, *,
                 ...
                 commercial_type: Optional[builtins.str] = None,
                 creation_date: Optional[builtins.str] = None,
                 dynamic_ip_required: Optional[builtins.bool] = None,
        ...
        :param builtins.str commercial_type: The server commercial type (eg. GP1-M)
        :param builtins.str creation_date: The server creation date (RFC 3339 format)
        :param builtins.bool dynamic_ip_required: True if a dynamic IP is required
        :param builtins.bool enable_ipv6: True if IPv6 is enabled
        :param builtins.str hostname: The server host name
        :param builtins.str id: The server unique ID
        ...
        :param builtins.str modification_date: The server modification date (RFC 3339 format)
        :param builtins.str name: The server name
        :param builtins.str organization: The server organization ID
        :param builtins.str private_ip: The server private IP address
        :param Sequence['ScalewayInstanceV1PrivateNIC'] private_nics: The server private NICs
        :param builtins.str project: The server project ID
        :param builtins.bool protected: The server protection option is activated
        ...
        :param builtins.str state_detail: The server state_detail
        :param Sequence[builtins.str] tags: The server associated tags
        :param Mapping[str, 'ScalewayInstanceV1VolumeServer'] volumes: The server volumes
        :param builtins.str zone: The zone in which is the server
        """
    ...
    def commercial_type(self) -> Optional[builtins.str]:
        """
    ...
    def dynamic_ip_required(self) -> Optional[builtins.bool]:
        """
...
class ScalewayInstanceV1ServerIpv6Properties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The server IPv6 address
        :param builtins.str address: The server IPv6 IP-Address (IPv6 address)
        :param builtins.str gateway: The IPv6 IP-addresses gateway (IPv6 address)
        :param builtins.str netmask: The IPv6 IP-addresses CIDR netmask
        """
...
class ScalewayInstanceV1ServerLocationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hypervisor_id: Optional[builtins.str] = None,
                 node_id: Optional[builtins.str] = None,
                 platform_id: Optional[builtins.str] = None,
    ...
    def hypervisor_id(self) -> Optional[builtins.str]:
    ...
    def platform_id(self) -> Optional[builtins.str]:
...
class ScalewayInstanceV1ServerPublicIpProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about the public IP
        :param builtins.str address: The server public IPv4 IP-Address (IPv4 address)
        :param builtins.bool dynamic: True if the IP address is dynamic
        :param builtins.str id: The unique ID of the IP address
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class ScalewayInstanceV1ServerType(dict):
    def __init__(__self__, *,
                 ...
                 ram: Optional[builtins.float] = None,
                 volumes_constraint: Optional['outputs.ScalewayInstanceV1ServerTypeVolumesConstraintProperties'] = None):
        """
        :param Sequence[builtins.str] alt_names: Alternative instance name if any
        :param 'ScalewayInstanceV1ServerTypeArch' arch: CPU architecture
        :param builtins.bool baremetal: True if it is a baremetal instance
        :param 'ScalewayInstanceV1ServerTypeCapabilitiesProperties' capabilities: Capabilities
        :param builtins.float gpu: Number of GPU
        :param builtins.float hourly_price: Hourly price in Euro
        :param builtins.float monthly_price: Estimated monthly price, for a 30 days month, in Euro
        :param builtins.float ncpus: Number of CPU
        ...
        :param builtins.float ram: Available RAM in bytes
    ...
    def alt_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def baremetal(self) -> Optional[builtins.bool]:
        """
    ...
    def hourly_price(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def ncpus(self) -> Optional[builtins.float]:
        """
        Number of CPU
        """
    ...
    @property
    @pulumi.getter
    def ram(self) -> Optional[builtins.float]:
        """
...
class ScalewayInstanceV1ServerTypeCapabilitiesProperties(dict):
    ...
    """
    def __init__(__self__, *,
                 block_storage: Optional[builtins.bool] = None,
                 boot_types: Optional[Sequence['ScalewayInstanceV1ServerTypeCapabilitiesPropertiesBootTypesItem']] = None):
        """
        Capabilities
        :param builtins.bool block_storage: True if server supports block storage
    ...
    def block_storage(self) -> Optional[builtins.bool]:
        """
...
class ScalewayInstanceV1ServerTypeNetworkInterface(dict):
    def __init__(__self__, *,
                 internal_bandwidth: Optional[builtins.float] = None,
                 internet_bandwidth: Optional[builtins.float] = None):
        """
        :param builtins.float internal_bandwidth: Maximum internal bandwidth in bits per seconds
        :param builtins.float internet_bandwidth: Maximum internet bandwidth in bits per seconds
        """
    ...
    def internal_bandwidth(self) -> Optional[builtins.float]:
        """
    ...
    def internet_bandwidth(self) -> Optional[builtins.float]:
        """
...
class ScalewayInstanceV1ServerTypeNetworkProperties(dict):
    ...
    """
    def __init__(__self__, *,
                 _ipv6_support: Optional[builtins.bool] = None,
                 interfaces: Optional[Sequence['outputs.ScalewayInstanceV1ServerTypeNetworkInterface']] = None,
                 sum_internal_bandwidth: Optional[builtins.float] = None,
                 sum_internet_bandwidth: Optional[builtins.float] = None):
        """
        Network available for the instance
        :param builtins.bool _ipv6_support: True if IPv6 is enabled
        :param Sequence['ScalewayInstanceV1ServerTypeNetworkInterface'] interfaces: List of available network interfaces
        :param builtins.float sum_internal_bandwidth: Total maximum internal bandwidth in bits per seconds
        :param builtins.float sum_internet_bandwidth: Total maximum internet bandwidth in bits per seconds
        """
    ...
    def _ipv6_support(self) -> Optional[builtins.bool]:
        """
        True if IPv6 is enabled
        """
    ...
    def sum_internal_bandwidth(self) -> Optional[builtins.float]:
        """
    ...
    def sum_internet_bandwidth(self) -> Optional[builtins.float]:
        """
...
class ScalewayInstanceV1ServerTypePerVolumeConstraintPropertiesLSsdProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 min_size: Optional[builtins.float] = None):
        """
        Local SSD volumes
        :param builtins.float max_size: Maximum volume size in bytes (in bytes)
        :param builtins.float min_size: Minimum volume size in bytes (in bytes)
        """
    ...
    def min_size(self) -> Optional[builtins.float]:
        """
...
class ScalewayInstanceV1Volume(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str project: The volume project ID
        :param builtins.str creation_date: The volume creation date (RFC 3339 format)
        :param builtins.str export_uri: Show the volume NBD export URI
        :param builtins.str modification_date: The volume modification date (RFC 3339 format)
        :param builtins.str organization: The volume organization ID
        :param 'ScalewayInstanceV1VolumeServerProperties' server: The server attached to the volume
        :param builtins.float size: The volume disk size (in bytes)
        :param Sequence[builtins.str] tags: The volume tags
        :param builtins.str zone: The zone in which is the volume
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "project", project)
        if creation_date is not None:
...
class ScalewayInstanceV1VolumeServer(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str creation_date: (RFC 3339 format)
        :param builtins.str modification_date: (RFC 3339 format)
        :param builtins.float size: (in bytes)
        """
        if boot is not None:
...
class ScalewayInstanceV1VolumeServerTemplate(dict):
    ...
    def __init__(__self__, *,
                 base_snapshot: Optional[builtins.str] = None,
                 boot: Optional[builtins.bool] = None,
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 organization: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str base_snapshot: The ID of the snapshot on which this volume will be based
        :param builtins.bool boot: Force the server to boot on this volume
        :param builtins.str id: UUID of the volume
        :param builtins.str name: Name of the volume
        :param builtins.str organization: Organization ID of the volume
        :param builtins.str project: Project ID of the volume
        :param builtins.float size: Disk size of the volume, must be a multiple of 512 (in bytes)
        """
    ...
    def base_snapshot(self) -> Optional[builtins.str]:
        """
