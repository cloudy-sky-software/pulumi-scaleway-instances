...
class PlacementGroupServersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] placement_group_id: UUID of the placement group
...
class PlacementGroupServers(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def servers(self) -> pulumi.Output[Optional[Sequence['outputs.ScalewayInstanceV1PlacementGroupServer']]]:
        return pulumi.get(self, "servers")
