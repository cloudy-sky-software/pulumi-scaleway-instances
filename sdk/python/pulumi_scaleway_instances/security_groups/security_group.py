...
class SecurityGroupArgs:
    def __init__(__self__, *,
                 ...
                 organization_default: Optional[pulumi.Input[builtins.bool]] = None,
                 outbound_default_policy: Optional[pulumi.Input['OutboundDefaultPolicy']] = None,
                 project_default: Optional[pulumi.Input[builtins.bool]] = None,
                 stateful: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SecurityGroup resource.
        :param pulumi.Input[builtins.str] project: The security group project ID
        :param pulumi.Input[builtins.str] description: The security groups description
        :param pulumi.Input[builtins.bool] enable_default_security: True if SMTP is blocked on IPv4 and IPv6. This feature is read only, please open a ticket if you need to make it configurable.
        :param pulumi.Input['InboundDefaultPolicy'] inbound_default_policy: The default inbound policy
        :param pulumi.Input[builtins.str] name: The security groups name
        :param pulumi.Input[builtins.str] organization: The security groups organization ID
        :param pulumi.Input[builtins.bool] organization_default: True if it is your default security group for this organization ID
        :param pulumi.Input['OutboundDefaultPolicy'] outbound_default_policy: The default outbound policy
        :param pulumi.Input[builtins.bool] project_default: True if it is your default security group for this project ID
        :param pulumi.Input[builtins.bool] stateful: True if the security group is stateful
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The security group tags
    ...
    def organization_default(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def organization_default(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def project_default(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def project_default(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SecurityGroup(pulumi.CustomResource):
    ...
    def creation_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def modification_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="organizationDefault")
    def organization_default(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if it is your default security group for this organization ID
        """
        return pulumi.get(self, "organization_default")
    ...
    @property
    @pulumi.getter(name="projectDefault")
    def project_default(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if it is your default security group for this project ID
        """
        return pulumi.get(self, "project_default")
