...
class BaseVolumeProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The volume on which the snapshot is based on
        :param builtins.str id: The volume ID on which the snapshot is based on
        :param builtins.str name: The volume name on which the snapshot is based on
        """
        if id is not None:
...
class ScalewayInstanceV1Snapshot(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_reason: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
        ...
        :param builtins.str creation_date: The snapshot creation date (RFC 3339 format)
        :param builtins.str error_reason: The reason for the failed snapshot import
        :param builtins.str modification_date: The snapshot modification date (RFC 3339 format)
        :param builtins.str name: The snapshot name
        :param builtins.str organization: The snapshot organization ID
        :param builtins.str project: The snapshot project ID
        :param builtins.float size: The snapshot size (in bytes)
        :param Sequence[builtins.str] tags: The snapshot tags
        :param builtins.str zone: The snapshot zone
        """
